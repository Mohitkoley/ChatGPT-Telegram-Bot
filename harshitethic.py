...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5110444290:AAF-DQeCe1v2HjyT6FwKM46lo8lYedNS1O4"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'gdrive upload bot'
username = 'googdriveupload_bot'
